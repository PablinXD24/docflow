...
# Chave e Endpoints do TMDb centralizados no backend
TMDB_API_KEY = os.environ.get("TMDB_API_KEY", "1f54bd990f1cdfb230adb312546d665d")
...
def recomendar_filmes():
    ...
    prompt = (
        ...
        "Retorne sua resposta estritamente no formato JSON puro contendo uma lista com os objetos no seguinte formato exato:\n"
        "[\n"
